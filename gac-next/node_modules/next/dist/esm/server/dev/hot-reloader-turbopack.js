...
import { isMetadataRoute, isMetadataRouteFile } from '../../lib/metadata/is-metadata-route';
...
export async function createHotReloaderTurbopack(opts, serverFields, distDir, resetFetch, lockfile, serverFastRefresh) {
    ...
    function clearRequireCache(key, writtenEndpoint, { force } = {}) {
        ...
        const usesServerHmr = serverFastRefresh && entryType === 'app' && writtenEndpoint.type !== 'edge' && !isMetadataRoute(entryPage);
        const filesToDelete = [];
